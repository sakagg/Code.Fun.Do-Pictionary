...
function line(e){
	...
	s.send("2n" + (x1/canvas.width).toPrecision(4) + "," + (y1/canvas.height).toPrecision(4))
}
...
function update(e) {
	...
	x1 = x
	y1 = y
	var tmpdata = (x/canvas.width).toPrecision(4).toString()+","+(y/canvas.height).toPrecision(4).toString();
	s.send("2"+tmpdata);
		console.log(tmpdata)
